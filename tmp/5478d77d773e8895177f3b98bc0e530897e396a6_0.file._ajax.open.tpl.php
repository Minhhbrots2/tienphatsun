<?php
/* Smarty version 3.1.33, created on 2026-08-07 15:08:53
  from '/www/wwwroot/tienphatsunrise.c-a.vn/application/views/member/_ajax.open.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a7592951b1dc9_66644564',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5478d77d773e8895177f3b98bc0e530897e396a6' => 
    array (
      0 => '/www/wwwroot/tienphatsunrise.c-a.vn/application/views/member/_ajax.open.tpl',
      1 => 1786085971,
      2 => 'file',
    ),
  ),
...
function content_6a7592951b1dc9_66644564 (Smarty_Internal_Template $_smarty_tpl) {
				...
				<div class="widget-content">
					...
					<div class="form-group form-row mb-2">
						...
						<div class="col-6 col-md-6 form-password-toggle">
							...
							<?php $_smarty_tpl->_assignInScope('ref_id', $_smarty_tpl->tpl_vars['clsISO']->value->getUniqid());?>

							<div class="input-group input-group-merge">

								<input type="password" class="form-control required" name="user_pass" data-val-required="Bạn chưa nhập vào mật khẩu" placeholder="············" aria-describedby="<?php echo $_smarty_tpl->tpl_vars['ref_id']->value;?>
" maxlength="255">

								<span class="input-group-text cursor-pointer" id="<?php echo $_smarty_tpl->tpl_vars['ref_id']->value;?>
">
						...
						<div class="col-6 col-md-6 form-password-toggle">
							...
							<div class="input-group input-group-merge">
								...
								<input type="password" class="form-control required" name="user_cpass" data-val-required="Bạn chưa nhập vào xác nhận mật khẩu" placeholder="············" aria-describedby="<?php echo $_smarty_tpl->tpl_vars['ref_id']->value;?>
" maxlength="255">
				...
				<div class="widget-content">
					...
					<div class="form-group form-row mb-2">
						...
						<div class="col-12 col-md-3 mb-2 mb-lg-0">
							...
							<input type="text" class="form-control required" name="code" data-val-required="Bạn chưa nhập vào tên nhóm nhân viên" value="<?php echo $_smarty_tpl->tpl_vars['clsProfile']->value->genCode();?>
" onClick="this.select()" maxlength="255" placeholder="FH0XXX" />
		...
		<div class="modal-footer align-items-center justify-content-between">
			...
			<button type="button" data-group_id="<?php echo $_smarty_tpl->tpl_vars['group_id']->value;?>
" data-type="save" class="btn btn-primary" 
