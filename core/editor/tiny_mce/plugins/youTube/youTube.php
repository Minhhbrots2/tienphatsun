...
<script type="text/javascript" src="includes/jquery-1.12.4.min.js?v=<?echo  time();?>"></script>
<script type="text/javascript" src="includes/jquery-ui-git.js?v=<?echo  time();?>"></script>
<script type="text/javascript" src="includes/youTube.js?v=<?echo  time();?>"></script>
<link rel="stylesheet" href="includes/jquery-ui.min.css?v=<?echo  time();?>" />  
<link rel="stylesheet" href="includes/youTube.css?v=<?echo  time();?>" />
            ...
            <div id="size_controls">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="form_label extra_opts">
							rel: <input type="checkbox" id="youtube_rel" />
							<label id="youtube_rel_label" for="youtube_rel">Off</label>
                        </td>
                    </tr>
                </tbody>
                </table>
