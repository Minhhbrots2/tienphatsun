...
class CI_DB_driver {
	...
	function __construct($params){
		...
		//trigger_error('Database Driver Class Initialized', E_USER_NOTICE);
	}
	/*
	|-------------------------------
	...
	function initialize(){
		...
		if ( ! $this->conn_id){
			trigger_error('Unable to connect to the database',E_USER_NOTICE);
			if ($this->db_debug)	{
	...
	function query($sql, $binds = FALSE, $return_object = TRUE){
		...
		if (FALSE === ($this->result_id = $this->simple_query($sql))){
			...
			if ($this->db_debug){
				...
				trigger_error('Query error: '.$error_msg, E_USER_ERROR);
	...
	function load_rdriver(){
		...
		if ( ! class_exists($driver)){
			include_once(DIR_LIBRARIES.'/database/DB_result.php');
			include_once(DIR_LIBRARIES.'/database/drivers/'.$this->dbdriver.'/'.$this->dbdriver.'_result.php');
		}
		return $driver;
	}
	/*
