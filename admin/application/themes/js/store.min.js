...
!function(d){"use strict";function a(o){var t=d(o).on("click.dropdown.data-api",this.toggle);d("html").on("click.dropdown.data-api",function(){t.parent().removeClass("open")})}var o='[data-toggle="dropdown"]';function e(){d(o).parent().removeClass("open")}a.prototype={constructor:a,toggle:function(o){var t,n,a,r=d(this);if(!r.is(".disabled, :disabled"))return n=(n=r.attr("data-target"))||(n=r.attr("href"))&&n.replace(/.*(?=#[^\s]*$)/,""),(t=d(n)).length||(t=r.parent()),a=t.hasClass("open"),e(),a||t.toggleClass("open"),!1}},d.fn.dropdown=function(n){return this.each(function(){var o=d(this),t=o.data("dropdown");t||o.data("dropdown",t=new a(this)),"string"==typeof n&&t[n].call(o)})},d.fn.dropdown.Constructor=a,d(function(){d("html").on("click.dropdown.data-api",e),d("body").on("click.dropdown",".dropdown form",function(o){o.stopPropagation()}).on("click.dropdown.data-api",o,a.prototype.toggle)})}(window.jQuery);
/*Timepicker */
 ...
 */
!function(e,t){var n;"object"==typeof exports&&exports?t(exports):(t(n={}),"function"==typeof define&&define.amd?define(n):e.Mustache=n)}(this,function(d){var k=/\s*/,y=/\s+/,r=/\S/,b=/\s*=/,x=/\s*\}/,U=/#|\^|\/|>|\{|&|=|!/,s=RegExp.prototype.test;function m(e){return t=r,n=e,!s.call(t,n);var t,n}var t=Object.prototype.toString,f=Array.isArray||function(e){return"[object Array]"===t.call(e)};function g(e){return"function"==typeof e}function E(e){return e.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g,"\\$&")}var n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};function T(e){if(!f(e)||2!==e.length)throw new Error("Invalid tags: "+e);return[new RegExp(E(e[0])+"\\s*"),new RegExp("\\s*"+E(e[1]))]}function i(e,t){e=e||"","string"==typeof(t=t||d.tags)&&(t=t.split(y));var n,r,s,i,o,a,c=T(t),h=new j(e),u=[],l=[],p=[],f=!1,g=!1;for(;!h.eos();){if(n=h.pos,s=h.scanUntil(c[0]))for(var v=0,w=s.length;v<w;++v)m(i=s.charAt(v))?p.push(l.length):g=!0,l.push(["text",i,n,n+1]),n+=1,"\n"===i&&function(){if(f&&!g)for(;p.length;)delete l[p.pop()];else p=[];g=f=!1}();if(!h.scan(c[0]))break;if(f=!0,r=h.scan(U)||"name",h.scan(k),"="===r?(s=h.scanUntil(b),h.scan(b),h.scanUntil(c[1])):"{"===r?(s=h.scanUntil(new RegExp("\\s*"+E("}"+t[1]))),h.scan(x),h.scanUntil(c[1]),r="&"):s=h.scanUntil(c[1]),!h.scan(c[1]))throw new Error("Unclosed tag at "+h.pos);if(o=[r,s,n,h.pos],l.push(o),"#"===r||"^"===r)u.push(o);else if("/"===r){if(!(a=u.pop()))throw new Error('Unopened section "'+s+'" at '+n);if(a[1]!==s)throw new Error('Unclosed section "'+a[1]+'" at '+n)}else"name"===r||"{"===r||"&"===r?g=!0:"="===r&&(c=T(t=s.split(y)))}if(a=u.pop())throw new Error('Unclosed section "'+a[1]+'" at '+h.pos);return function(e){for(var t,n=[],r=n,s=[],i=0,o=e.length;i<o;++i)switch((t=e[i])[0]){case"#":case"^":r.push(t),s.push(t),r=t[4]=[];break;case"/":s.pop()[5]=t[2],r=0<s.length?s[s.length-1][4]:n;break;default:r.push(t)}return n}(function(e){for(var t,n,r=[],s=0,i=e.length;s<i;++s)(t=e[s])&&("text"===t[0]&&n&&"text"===n[0]?(n[1]+=t[1],n[3]=t[3]):(r.push(t),n=t));return r}(l))}function j(e){this.string=e,this.tail=e,this.pos=0}function o(e,t){this.view=null==e?{}:e,this.cache={".":this.view},this.parent=t}function e(){this.cache={}}j.prototype.eos=function(){return""===this.tail},j.prototype.scan=function(e){var t=this.tail.match(e);if(t&&0===t.index){var n=t[0];return this.tail=this.tail.substring(n.length),this.pos+=n.length,n}return""},j.prototype.scanUntil=function(e){var t,n=this.tail.search(e);switch(n){case-1:t=this.tail,this.tail="";break;case 0:t="";break;default:t=this.tail.substring(0,n),this.tail=this.tail.substring(n)}return this.pos+=t.length,t},o.prototype.push=function(e){return new o(e,this)},o.prototype.lookup=function(e){var t;if(e in this.cache)t=this.cache[e];else{for(var n=this;n;){if(0<e.indexOf(".")){t=n.view;for(var r=e.split("."),s=0;null!=t&&s<r.length;)t=t[r[s++]]}else t=n.view[e];if(null!=t)break;n=n.parent}this.cache[e]=t}return g(t)&&(t=t.call(this.view)),t},e.prototype.clearCache=function(){this.cache={}},e.prototype.parse=function(e,t){var n=this.cache,r=n[e];return null==r&&(r=n[e]=i(e,t)),r},e.prototype.render=function(e,t,n){var r=this.parse(e),s=t instanceof o?t:new o(t);return this.renderTokens(r,s,n,e)},e.prototype.renderTokens=function(e,t,n,r){var s,i,o="",a=this;function c(e){return a.render(e,t,n)}for(var h=0,u=e.length;h<u;++h)switch((s=e[h])[0]){case"#":if(!(i=t.lookup(s[1])))continue;if(f(i))for(var l=0,p=i.length;l<p;++l)o+=this.renderTokens(s[4],t.push(i[l]),n,r);else if("object"==typeof i||"string"==typeof i)o+=this.renderTokens(s[4],t.push(i),n,r);else if(g(i)){if("string"!=typeof r)throw new Error("Cannot use higher-order sections without the original template");null!=(i=i.call(t.view,r.slice(s[3],s[5]),c))&&(o+=i)}else o+=this.renderTokens(s[4],t,n,r);break;case"^":(!(i=t.lookup(s[1]))||f(i)&&0===i.length)&&(o+=this.renderTokens(s[4],t,n,r));break;case">":if(!n)continue;null!=(i=g(n)?n(s[1]):n[s[1]])&&(o+=this.renderTokens(this.parse(i),t,n,i));break;case"&":null!=(i=t.lookup(s[1]))&&(o+=i);break;case"name":null!=(i=t.lookup(s[1]))&&(o+=d.escape(i));break;case"text":o+=s[1]}return o},d.name="mustache.js",d.version="0.8.1",d.tags=["{{","}}"];var a=new e;d.clearCache=function(){return a.clearCache()},d.parse=function(e,t){return a.parse(e,t)},d.render=function(e,t,n){return a.render(e,t,n)},d.to_html=function(e,t,n,r){var s=d.render(e,t,n);if(!g(r))return s;r(s)},d.escape=function(e){return String(e).replace(/[&<>"'\/]/g,function(e){return n[e]})},d.Scanner=j,d.Context=o,d.Writer=e});
...
/** Scroll */
!function(t,e){"function"==typeof define&&define.amd?define(["exports"],e):"undefined"!=typeof exports?e(exports):e(t.dragscroll={})}(this,function(t){var s,c,a=window,d=document,f="mousemove",h="mouseup",u="mousedown",e="EventListener",m="add"+e,n="remove"+e,o=[],e=function(t,e){for(t=0;t<o.length;)(e=(e=o[t++]).container||e)[n](u,e.md,0),a[n](h,e.mu,0),a[n](f,e.mm,0);for(o=[].slice.call(d.getElementsByClassName("dragscroll")),t=0;t<o.length;)!function(e,n,o,i,r,l){(l=e.container||e)[m](u,l.md=function(t){e.hasAttribute("nochilddrag")&&d.elementFromPoint(t.pageX,t.pageY)!=l||(i=1,n=t.clientX,o=t.clientY)},0),a[m](h,l.mu=function(){i=0},0),a[m](f,l.mm=function(t){i&&((r=e.scroller||e).scrollLeft-=s=-n+(n=t.clientX),r.scrollTop-=c=-o+(o=t.clientY),e==d.body&&((r=d.documentElement).scrollLeft-=s,r.scrollTop-=c))},0)}(o[t++])};"complete"==d.readyState?e():a[m]("load",e,0),t.reset=e}),function(r){r.fn.tableHeadFixer=function(t){var s=r.extend({},{head:!0,foot:!1,left:0,right:0,dragscroll:!1,pagination:!1},t);return this.each(function(){var t,e,l,n,o;s.table=this,s.parent=r("<div"+(1==s.dragscroll?' class="dragscroll"':"")+"></div>"),e=r(s.table).parent(),l=r(s.parent),n=r(s.table),o=e.css("height"),1==s.pagination&&(o-=40),n.before(l),l.append(n),l.css({width:"100%",height:o,"overflow-x":"scroll","max-height":e.css("max-height"),"min-height":e.css("min-height"),"max-width":e.css("max-width"),"min-width":e.css("min-width")}),l.scroll(function(){var t=l[0].scrollWidth,e=l[0].clientWidth,n=l[0].scrollHeight,o=l[0].clientHeight,i=l.scrollTop(),r=l.scrollLeft();s.head&&this.find("thead tr > *").css("top",i),s.foot&&this.find("tfoot tr > *").css("bottom",n-o-i),0<s.left&&s.leftColumns.css("left",r),0<s.right&&s.rightColumns.css("right",t-e-r)}.bind(n)),1==s.head&&((t=r(s.table).find("thead")).find("tr"),i(t=t.find("tr > *")),t.css({position:"relative"})),1==s.foot&&((t=r(s.table).find("tfoot")).find("tr"),i(t=t.find("tr > *")),t.css({zIndex:2,position:"relative"})),0<s.left&&function(){var t=r(s.table),e=s.left;s.leftColumns=r();for(var n=1;n<=e;n++)s.leftColumns=s.leftColumns.add(t.find("tr > *:nth-child("+n+")"));s.leftColumns.each(function(t,e){i(e=r(e)),e.css({zIndex:2,position:"relative"})})}(),0<s.right&&function(){var t=r(s.table),e=s.right;s.rightColumns=r();for(var n=1;n<=e;n++)s.rightColumns=s.rightColumns.add(t.find("tr > *:nth-last-child("+n+")"));s.rightColumns.each(function(t,e){i(e=r(e)),e.css({zIndex:2,position:"relative"})})}(),r(s.parent).trigger("scroll"),r(window).resize(function(){r(s.parent).trigger("scroll")})});function i(t){t.each(function(t,e){var e=r(e),n=r(e).parent(),o="transparent"==(o=e.css("background-color"))||"rgba(0, 0, 0, 0)"==o?null:o,n=n.css("background-color"),n=(n="transparent"==n||"rgba(0, 0, 0, 0)"==n?null:n)||"white",n=o||n;e.css("background-color",n)})}}}(jQuery);
/**
...
TwbsToggleButtons.prototype._eventClick=function(a){var b=this.$_element.find(this._options.twbsBtnSelector).filter(function(){return"true"===this.getAttribute("aria-pressed")}).toArray();a=a.currentTarget;this._getInputType()===TwbsToggleButtons.TYPE_RADIO()?(b=[a],"true"===a.getAttribute("aria-pressed")&&0===this.$_element.find(this._options.twbsBtnSelector).find(":input[required]").length&&(b=[])):"true"===a.getAttribute("aria-pressed")&&-1!==b.indexOf(a)?b.splice(b.indexOf(a),1):b.push(a);this._resetDOM(b);
return!0};TwbsToggleButtons.prototype._activateButton=function(a){void 0!==a.dataset.twbsToggleButtonsClassActive&&0<a.dataset.twbsToggleButtonsClassActive.length?a.classList.add(a.dataset.twbsToggleButtonsClassActive):this._options.classActive.forEach(function(b){a.classList.add(b)});this._options.classInactive.forEach(function(b){a.classList.remove(b)});$(a).find(":input").attr("checked","checked").trigger('change')};
