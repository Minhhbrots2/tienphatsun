	...
	<div class="ui-title-bar">
		...
		<div class="ui-title-bar__main-group">
			<div class="ui-title-bar__heading-group">
				...
				<p class="type--subdued">{$core->get_Lang('systemmanagementfaqcat')}</p>
			</div>
		</div>
					...
					<div class="ui-card__section has-bulk-actions pages">
						...
						<table class="table table-vertical table-striped" width="100%">
							<thead><tr>
								...
								<th class="text-center" colspan="4" width="6%">{$core->get_Lang('move')}</th>
								<th class="text-center" width="100px">{$core->get_Lang('Action')}</th>
							</tr></thead>
