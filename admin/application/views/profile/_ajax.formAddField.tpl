	...
	<div class="modal-content">
		...
		<form action="" method="post" id="frmIssue" encrupt="miltipart/form-data">
				...
				{if $field eq "history_sale"}
					<div class="form-group form-row">
						...
						<div class="col-xs-12 col-md-10">
							<input type="text" class="form-control form_field required" placeholder="Nhập mã căn" onchange="$Core.member.check_stock_code(this, event)" name="stock_code" value="{$oneItem.stock_code}">
						</div>
					</div>
					<div class="form-group form-row">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn btn-primary" onClick="$Core.member.AddField(this,{if $field eq 'history_sale'}'addHistorySale'{else}'add'{/if})"  data-member_id='{$member_id}' data-field="{$field}">
