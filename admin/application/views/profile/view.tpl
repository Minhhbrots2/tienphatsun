				...
				<div class="box-title no-border-bottom">
					<div class="vcard d-flex">
						...
						<div class="vcard-body">
							...
							<a href="javascript:void(0);" class="SiteClickPublic" clsTable="Profile" pkey="profile_id" sourse_id="{$pvalTable}" rel="{$oneItem.is_active}" title="{$core->get_Lang('Click to change status')}">
		...
		<div class="col-md-4">
			<div class="box light">
				<div class="box-title no-border-bottom">
					...
					<a class="pull-right" href="{$PCMS_URL}/index.php?mod={$mod}&act=edit&{$pkeyTable}={$pvalTable}&profile_type={$oneItem.profile_type}">Sửa</a>
				</div>
				<div class="box-body">
