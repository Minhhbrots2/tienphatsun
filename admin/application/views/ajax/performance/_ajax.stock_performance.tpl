					...
					<tbody>
						...
						<tr class="nohover">
							...
							<td class="text-nowrap text-dark fw-bold p-0" style="background-color:#ffe0a1 !important;">
								<input type="date" name="time_buy" data-type="time_buy" class="form-control-plaintext text-dark fw-bold fs-14 px-2" value="{$today}" onchange="$Core.performance.loadTime(this,event)" uid="{$uid}">
							</td>
						...
						<tr class="nohover">
							...
							<td class="text-nowrap text-dark fw-bold p-0" style="background-color:#ffe0a1 !important;">
								<input type="date" name="time_profit" data-type="time_profit" class="form-control-plaintext text-dark fw-bold fs-14 px-2" value="{$time_profit}" onchange="$Core.performance.loadTime(this,event)" uid="{$uid}" min="{$today}">
							</td>
						...
						<tr class="nohover">
							...
							<td class="text-nowrap text-dark fw-bold p-0" style="background-color:#ffe0a1 !important;">
								<input type="date" name="time_leasing" data-type="time_leasing" class="form-control-plaintext text-dark fw-bold fs-14 px-2" value="{$time_leasing}" onchange="$Core.performance.loadTime(this,event)" uid="{$uid}" min="{$today}">
							</td>
						...
						<tr class="nohover">
							...
							<td class="text-nowrap text-dark fw-bold p-0" style="background-color:#ffe0a1 !important;">
								<input type="date" name="time_AHNG" data-type="time_AHNG" class="form-control-plaintext text-dark fw-bold fs-14 px-2" value="{$time_AHNG}" onchange="$Core.performance.loadTime(this,event)" uid="{$uid}">
							</td>
							<td class="text-nowrap text-dark" style="background-color:#ffe0a1 !important;">Theo CSBH T7/2024</td>
						</tr>
					</tbody>
				...
				<table class="table table-iloocal table-computer table-bordered mb-2">
					...
					<tbody>
						...
						<tr class="nohover tr_input tr_input_revenue">
							...
							<td class="text-dark {if $deviceType eq 'phone'}text-nowrap{else}text-wrap{/if}">Thị trường CHCC có mức tăng giá hàng năm từ 8-12%/năm (kết hợp cùng tăng giá của CĐT)</td>
