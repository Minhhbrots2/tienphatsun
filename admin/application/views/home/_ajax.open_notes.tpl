<div class="modal-dialog">
	<form method="post" class="modal-content">
		...
		<div class="modal-footer">
			<button type="button" onClick="$Core.home.approve(this, event)" data-action="{$action}" 
			data-table="{$table}" data-type="{$type}" data-id="{$id}" class="btn btn-success">Xác nhận</button> 
