		...
		<form method="post" action="" enctype="multipart/form-data">
			<div class="modal-body">
				<div class="form-group form-row">
					...
					<label class="col-md-2 col-form-label text-right">Danh mục</label>
					{assign var = toId value = $clsISO->getUniqid()}
					<div class="col-md-3">
						<select class="form-control" toId="{$toId}" name="cat_id">
							{$clsProperty->getSelectByProperty('_CATEGORYSERVICES',$oneService.cat_id)}
						</select>
					</div>
				</div>
				<div class="form-group form-row">
