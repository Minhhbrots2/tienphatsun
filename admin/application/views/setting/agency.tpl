<div class="ui-title-bar-container ui-title-bar-container--full-width" style="position: sticky;top: 100px;z-index: 1">
	<div class="ui-title-bar card p-3">
		<div class="ui-title-bar__main-group">
			<div class="ui-title-bar__heading-group d-block">
				...
				<a class="h5" href="{$clsConfiguration->getValue('gdrive_agency')}" target="_blank">Link đại lý thấp tầng</a>
			</div>
		</div>
					...
					<div class="ui-card__section has-bulk-actions pages">
						<form method="post">
							<div class="form-search form-inline">
								...
								<button type="submit" class="btn btn-success mb-0">{$core->makeIcon('search', 'Search')}</button>
										...
										<tr>
											...
											{if !empty($agency_hidden_stock_FH)}
												{foreach from=$agency_hidden_stock_FH item=hidden_stock}
													<th class="text-center" width="15%">{$hidden_stock.title}</th>
												{/foreach}
											{/if}										
