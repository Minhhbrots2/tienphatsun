		...
		<div class="action-bar">
			<div class="ui-title-bar__mobile-primary-actions">
				<div class="ui-title-bar__actions">
					<a href="{$PCMS_URL}/index.php?mod=setting&act=property&group=mygreenparadise#_CATEGORYFAQS_MGP" class="btn btn-primary text-white mr-2 ui-title-bar__action">{$core->get_Lang('Category')}</a>
					<a href="{$PCMS_URL}/index.php?mod={$mod}&act=edit" class="btn btn-success ui-title-bar__action">{$core->makeIcon('plus', $core->get_Lang('Addnew'))}</a>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="ui-card__section has-bulk-actions pages">
						<form method="post">
							<div class="form-search d-flex align-items-center justify-content-between">
								<div class="d-flex form-inline w-50">
									<select name="cat_id" class="iso-selectize w-50 mr-2 required" data-width="100%">
										...
										<td class="text-center" style="white-space:nowrap;">
											<div class="btn-group dropdown">
												...
												<ul class="dropdown-menu" style="right:0px !important; left:auto">
													...
													<li><a title="{$core->get_Lang('edit')}" href="{$PCMS_URL}/?mod={$mod}&act=edit&faq_id={$faq_id}"><i class="icon-edit"></i> <span>{$core->get_Lang('edit')}</span></a></li>
