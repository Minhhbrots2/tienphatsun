		...
		<div class="action-bar">
			<div class="ui-title-bar__mobile-primary-actions">
				<div class="ui-title-bar__actions">
					<a href="javascript:void(0);" onClick="$Core.shop.open(this, event)" shop_id="0" class="ui-button ui-button--primary ui-title-bar__action">{$core->get_Lang('Addnew')}</a>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="ui-card__section has-bulk-actions pages">
						<form method="post">
							<div class="form-search form-inline">
								...
								<div class="form-group">
									<select name="project_id" class="form-control" onChange="$Core.shop.select_block(this, event)" toId="{$toId}_Block_Id">
