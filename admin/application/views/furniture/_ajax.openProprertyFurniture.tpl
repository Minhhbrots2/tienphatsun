	...
	<div class="modal-content">
		...
		<form method="post" action="" enctype="multipart/form-data">
			...
			<div class="modal-footer">
				...
				<button type="button" onClick="$Core.furniture.proprertyFurniture(this,'load')" data-type="{$typeOption}" data-id_dup="{$id_dup}" data-furniture_id="{$oneItem.furniture_id}" data-cat_id="{$cat_id}" class="btn btn-success">
					<span>Cập nhật</span>
				</button>
