				...
				<form method="post">
					<div class="form-search form-inline">
						...
						<div class="form-group w-30">
							<select name="member_id" placeholder="Tìm kiếm member" class="iso-selectizeLiveSearch" data-url="{$PCMS_URL}/index.php?mod={$mod}&act=aj_search_members">
								{if $member_id gt '0'}
								<option value="{$member_id}" selected="selected">{$clsMember->getIndentity($member_id)}</option>
								{/if}
							</select>
						</div>
