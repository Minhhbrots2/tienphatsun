<div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
	<form action="" method="post" class="modal-content" encrypt="miltipart/form-data">
				...
				{if !empty($arr_worksheets)}
					...
					<tr>
						<td class="align-center text-center">
							<label class="switch">
								<input type="checkbox" class="{$spreadsheetId}" name="sheets[]" sheet_id="{$_oKey}" value="{$_oSheet}">
						...
						<td class="align-center text-center">
							<label class="switch">
								<input type="checkbox" class="is_stock_point_{$spreadsheetId}" name="is_stock_point[]" value="1">
								<span class="slider round"></span>
							</label>
						</td>
					</tr>
		...
		<div class="modal-footer">
			<button type="button" onclick="$Core.crawl.update_sheet(this, event)" gId="{$gId}" stock_type="{$stock_type}" spreadsheetId="{$spreadsheetId}" 
