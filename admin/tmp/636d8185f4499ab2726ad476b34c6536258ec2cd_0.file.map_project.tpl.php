...
/* Smarty version 3.1.33, created on 2026-07-30 10:25:54
  from '/www/wwwroot/tienphatsunrise.c-a.vn/admin/application/views/blocks/map_project.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a6ac442082196_63552837',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '636d8185f4499ab2726ad476b34c6536258ec2cd' => 
    array (
      0 => '/www/wwwroot/tienphatsunrise.c-a.vn/admin/application/views/blocks/map_project.tpl',
      1 => 1784691580,
      2 => 'file',
    ),
  ),
...
function content_6a6ac442082196_63552837 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="ui-card">
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-md-12">
						...
						<div class="input-group w-100">
							...
							<input id="search-input" name="map_address" value="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['map_address'];?>
" type="text" class="form-control" placeholder="Nhập địa chỉ"/>
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-md-6">
						...
						<input type="text" id="map_la" value="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['map_la'];?>
" name="map_la" class="form-control" />

					</div>

					<div class="col-xs-12 col-md-6">

						<input type="text" id="map_lo" value="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['map_lo'];?>
" name="map_lo" class="form-control" />
					...
					<div class="col-12 col-md-6 col-lg-8">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-md-6">
								...
								<input type="number" min="0" max="19" value="<?php echo $_smarty_tpl->tpl_vars['more_information']->value['map_zoom'];?>
" name="map_zoom" class="form-control" placeholder="Độ phóng đại của bản đồ"/>
					...
					<div class="col-12 col-md-6 col-lg-4">
						...
						<div class="overflow-y-auto" style="max-height: 500px">
							...
							<?php if (count($_smarty_tpl->tpl_vars['more_information']->value['location_block']) > 0) {?>

								<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['more_information']->value['location_block'], 'locationItem', false, NULL, 'loop', array (
  'iteration' => true,
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['locationItem']->value) {
								...
								<div class="form-group item-location item-location_block mt-3 d-flex align-item-center">
									...
									<div class="form-row">
										...
										<div class="col-xs-12 col-md-12 mt-2">
											...
											<label class="form-label position-location">Vị trí <?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration'] : null);?>
</label>
										...
										<div class="col-xs-12 col-md-12 mt-2">
											...
											<div class="input-group w-100">
												...
												<input id="search-input" name="map_address_block[]" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['address'];?>
" type="text" class="form-control map_address_block" placeholder="Nhập địa chỉ"/>
										...
										<div class="col-xs-12 col-md-4 mt-2">
											...
											<select name="map_block_id[]" id="" class="form-control form-select">
												...
												<?php echo $_smarty_tpl->tpl_vars['clsProperty']->value->getSelectByPropertyOrigin("_BLOCK",$_smarty_tpl->tpl_vars['pvalTable']->value,$_smarty_tpl->tpl_vars['locationItem']->value['block_id']);?>
										...
										<div class="col-xs-12 col-md-4 mt-2">
											...
											<input type="text" id="map_la_<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration'] : null);?>
" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['lat'];?>
" name="map_block_lat[]" class="form-control input_map_block_lat" placeholder="lat"/>

										</div>

										<div class="col-xs-12 col-md-4 mt-2">

											<input type="text" id="map_lo_<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration'] : null);?>
" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['lng'];?>
" name="map_block_lng[]" class="form-control input_map_block_lng" placeholder="long"/>

										</div>

									</div>

									<div class="delete-location <?php if (count($_smarty_tpl->tpl_vars['more_information']->value['location_block']) <= 1) {?> d-none <?php }?>">
...
" type="text" class="form-control map_address_block" placeholder="Nhập địa chỉ"/>
										...
										<div class="col-xs-12 col-md-4 mt-2">
											...
											<input type="text" id="map_la_1" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['lat'];?>
" name="map_block_lat[]" class="form-control input_map_block_lat" placeholder="lat"/>
										...
										<div class="col-xs-12 col-md-4 mt-2">
											...
											<input type="text" id="map_lo_1" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['lng'];?>
" name="map_block_lng[]" class="form-control input_map_block_lng" placeholder="long"/>
...
" name="map_zoom" class="form-control" placeholder="Độ phóng đại của bản đồ"/>
					...
					<div class="col-12 col-md-6 col-lg-4">
						...
						<div class="overflow-y-auto" style="max-height: 500px">
							...
							<?php if (count($_smarty_tpl->tpl_vars['more_information']->value['location_highlight']) > 0) {?>

								<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['more_information']->value['location_highlight'], 'locationItem', false, NULL, 'loop', array (
  'iteration' => true,
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['locationItem']->value) {
										...
										<div class="form-row">
											...
											<div class="col-xs-12 col-md-12 mt-2">
												...
												<div class="input-group w-100">
													...
													<input id="search-input" name="map_address_highlight[]" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['address'];?>
" type="text" class="form-control map_address_highlight" placeholder="Nhập địa chỉ"/>
											...
											<div class="col-xs-12 col-md-4 mt-2">
												...
												<input type="text" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['name'];?>
" name="map_highlight_name[]" class="form-control input_map_highlight_name" placeholder="tên địa điểm"/>
											...
											<div class="col-xs-12 col-md-4 mt-2">
												...
												<input type="text" id="map_la_<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration'] : null);?>
" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['lat'];?>
" name="map_highlight_lat[]" class="form-control input_map_highlight_lat" placeholder="lat"/>
											...
											<div class="col-xs-12 col-md-4 mt-2">
												...
												<input type="text" id="map_lo_<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_loop']->value['iteration'] : null);?>
" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['lng'];?>
" name="map_highlight_lng[]" class="form-control input_map_highlight_lng" placeholder="long"/>

											</div>

										</div>

										<div class="delete-location <?php if (count($_smarty_tpl->tpl_vars['more_information']->value['location_highlight']) <= 1) {?> d-none <?php }?>">
									...
									<div class="form-row">
										...
										<div class="col-xs-12 col-md-12 mt-2">
											...
											<div class="input-group w-100">
												...
												<input id="search-input" name="map_address_highlight[]" value="<?php echo $_smarty_tpl->tpl_vars['locationItem']->value['address'];?>
" type="text" class="form-control map_address_highlight" />
		...
		<div class="ui-type-container">
			...
			<div class="p-md-3 box-location-territory box-group-location">
                    ...
                    <div class="input-group w-100">
                        ...
                        <input id="map_address_territory" name="map_address_territory" value="<?php if (!empty($_smarty_tpl->tpl_vars['more_information']->value['map_address_territory'])) {?> <?php echo $_smarty_tpl->tpl_vars['more_information']->value['map_address_territory'];?>
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['more_information']->value['map_address'];?>
 <?php }?>" type="text" class="form-control map_address_territory" placeholder="Nhập địa chỉ ..." />
                ...
                <div class="form-group row list-location mt-3 d-flex align-item-center" data-territory=<?php echo json_encode($_smarty_tpl->tpl_vars['info_map_territory']->value);?>
>

                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['info_map_territory']->value, 'item_territory', false, 'key', 'name', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key']->value => $_smarty_tpl->tpl_vars['item_territory']->value) {
?>

                        <div class="item_round round_<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
" data-round="<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
">

                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['item_territory']->value, 'item_territory_location', false, 'key_location', 'name_location', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['key_location']->value => $_smarty_tpl->tpl_vars['item_territory_location']->value) {
?>

                            <input type="hidden" id="map_la_1" value="<?php echo $_smarty_tpl->tpl_vars['item_territory_location']->value[0];?>
" name="map_territory_lat[<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
][]" class="form-control input_map_territory_lat" placeholder="lat"/>

                            <input type="hidden" id="map_lo_1" value="<?php echo $_smarty_tpl->tpl_vars['item_territory_location']->value[1];?>
" name="map_territory_lng[<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
][]" class="form-control input_map_territory_lng" placeholder="long"/>
...
<?php echo '<script'; ?>
 src="https://unpkg.com/leaflet-control-geocoder/dist/Control.Geocoder.js"><?php echo '</script'; ?>
>

<?php echo '<script'; ?>
>

    var user_id = "<?php echo $_smarty_tpl->tpl_vars['core']->value->_USER['user_id'];?>
";

    var lat = "<?php echo $_smarty_tpl->tpl_vars['more_information']->value['map_la'];?>
";

    var lng = "<?php echo $_smarty_tpl->tpl_vars['more_information']->value['map_lo'];?>
";
