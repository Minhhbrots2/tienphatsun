<?php
/* Smarty version 3.1.33, created on 2026-08-07 16:31:07
  from '/www/wwwroot/tienphatsunrise.c-a.vn/admin/application/views/editor/image.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6a75a5db9cfef2_20786096',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a14c94802715a6dfb24b01fa35fae780b695d5fb' => 
    array (
      0 => '/www/wwwroot/tienphatsunrise.c-a.vn/admin/application/views/editor/image.tpl',
      1 => 1784691612,
      2 => 'file',
    ),
  ),
...
function content_6a75a5db9cfef2_20786096 (Smarty_Internal_Template $_smarty_tpl) {
...
/editor/jquery/jquery-1.11.0.min.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/editor/tiny_mce/tiny_mce_popup.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/editor/tiny_mce/utils/mctabs.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/editor/tiny_mce/utils/form_utils.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/editor/tiny_mce/utils/validate.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/editor/tiny_mce/utils/editable_selects.js"><?php echo '</script'; ?>
>
	<?php echo '<script'; ?>
 type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/editor/tiny_mce/plugins/advimage/js/image.js"><?php echo '</script'; ?>
> 
	<link href="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/editor/tiny_mce/plugins/advimage/css/advimage.css" rel="stylesheet" type="text/css" />
    
    <?php echo '<script'; ?>
 type="text/javascript">var path_ajax = '<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
...
/jquery.form.js"><?php echo '</script'; ?>
>
...
>
    <?php echo '<script'; ?>
 type="text/javascript" src="/core/isoman/js/jquery.cookie.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 type="text/javascript" src="/core/isoman/js/man.js"><?php echo '</script'; ?>
>
    <link rel="stylesheet" href="/core/isoman/css/skin.css" type="text/css" media="all">
    
</head>
<body id="advimage" style="display: none">
    <form action="" id="theForm" name="theForm" method="post" enctype="multipart/form-data"> 
		<div class="tabs">
			<ul>
...
>
							...
							<tr>
								...
								<td colspan="2"><table border="0" cellspacing="0" cellpadding="0">
									<tr> 
									  <td><input name="src" type="text" id="src" value="<?php echo $_smarty_tpl->tpl_vars['imageFile']->value;?>
" class="mceFocus" onchange="ImageDialog.showPreviewImage(this.value);" /></td>
									  <td id="srcbrowsercontainer">&nbsp;</td>
                                      <!-- <td>
                                      	  <?php if ($_smarty_tpl->tpl_vars['_isoman_use']->value == 1) {?>
                                          <a href="#" class="ajOpenDialogIframe" isoman_for_id="src"><img src="/core/isoman/images/folderopen.gif" border="0" title="Open" alt="Open"></a>                                    
                                          <?php } else { ?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['imageFile']->value != '') {?>
    <?php echo '<script'; ?>
 type="text/javascript">var imageFile='<?php echo $_smarty_tpl->tpl_vars['imageFile']->value;?>
';<?php echo '</script'; ?>
>
