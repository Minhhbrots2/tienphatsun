	...
	<form class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="modalTopTitle">
				{if $tp eq 'edit'}Chỉnh sửa báo cáo{elseif $tp eq 'quote'}Phản hồi{else}Thêm mới báo cáo{/if}
			</h5>
		...
		<div class="modal-body">
			...
			<div class="d-flex align-items-center justify-content-between mt-2">
				<div class="toolbar d-flex align-items-center">
					<div class="mr-2">
						<a data-bs-toggle="tooltip" uid="{$upload_id}" onClick="issue_notes_upload(this, event)" issue_id="{$issue_id}" issue_note_id="{$issue_note_id}" data-bs-offset="0,4" data-bs-placement="top" title="Đính kèm file" href="javascript:void(0)"><img src="{$smarty.const.ICON_ATTACHMENT}" /></a>
					</div>
					<div class="mr-2">
						<a data-bs-toggle="tooltip" gid="{$gid}" onClick="set_mention_list(this,event)" data-bs-offset="0,4" data-bs-placement="top" title="Gắn thẻ" href="javascript:void(0)"><img src="{$smarty.const.ICON_MENTION}" /></a>
					</div>
				</div>
			</div>
