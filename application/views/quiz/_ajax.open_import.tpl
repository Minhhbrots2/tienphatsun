<div class="modal-dialog">
	<form method="post" action="" enctype="multipart/form-data" class="modal-content" id="frmIssue">
		<div class="modal-header"> 
			<h5 class="modal-title"><strong>Import danh sách câu hỏi</strong></h5>
			...
			<table class="form" cellpadding="0" cellspacing="2" width="100%">
				<tr>
					<td class="fieldarea" colspan="2">
						<strong>Step 1: Mẫu</strong>
					</td>
				</tr>
				<tr>
					<td class="fieldlabel" width="25%"></td>
					<td class="fieldarea">
						<a data-toggle="ripple" href="{$PCMS_URL}/templates/QUIZ_TEST.xlsx" target="_blank" class="btn btn-outline-primary"><svg width="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" fill="#FFF" stroke-miterlimit="10" stroke-width="2">
				...
				<tr>
					...
					<td class="fieldarea" colspan="3">
						<div class="input-group" >
							...
							<input type="file" name="fileimport" class="form-control fileimport" onChange="$Core.quiz.config_column(this,event)" />
							<button type="button" onClick="$Core.quiz.config_column(this,event)" tp="upload_file" 
				...
				<tr>
					...
					<td class="fieldarea" colspan="3">
						<div class="input-group" >
							...
							<button type="button" onClick="$Core.quiz.config_column(this,event)" tp="google_sheet" 
								class="btn btn-icon btn-outline-default"><i class="bx bx-cog"></i></button>	
						</div>
						<small class="form-text">Tên sheet cần Import phải có tên là <strong class="text-main">"QUIZ_TEST"</strong></small>
					</td>
				</tr>
			</table>
		</div>
		<div class="modal-footer"> 
			...
			<button type="button" class="btn btn-primary" onClick="$Core.quiz.do_import(this, event)">
