			...
			<div class="card">
				<div class="card-header">
					<div class="d-flex  align-items-center justify-content-between">
						<h5 class="chat-title mb-0">Automation</h5>
						<button onClick="$Core.automation.open(this, event)" template_id="0" type="button" class="btn btn-outline-default {if $deviceType eq 'phone'}btn-sm{/if}">
							<i class="bx bx-plus"></i> Thêm chiến dịch
						</button>
					</div>
				</div>
				<div class="card-body">
