				...
				<td>
					<div class="btn-group">
						...
						<ul class="dropdown-menu" style="right:0px !important; left: auto">
							<li><a title="Sửa" href="javascript:void(0)"  onClick="$Core.member.formAddField(this,'open')"  data-profile_id='{$profile_id}' data-field_id="{$key}" data-field="{$field}" data-type="edit"><i class="icon-edit"></i> <span>Sửa</span></a></li>
							<li><a href="javascript:void(0)" onClick="$Core.member.deleteField(this,'delete')" data-profile_id='{$profile_id}' data-field_id="{$key}" data-field="{$field}"><i class="icon-trash"></i> <span>Xoá</span></a></li>
						</ul>
					</div>
				</td>
			</tr>
				...
				<td>
					<div class="btn-group">
						...
						<ul class="dropdown-menu dropdown-menu-end" style="">
							<li><a class="dropdown-item" href="javascript:void(0)"  onClick="$Core.member.formAddField(this,'open')" data-profile_id='{$profile_id}' data-field_id="{$key}"  data-field="{$field}" data-type="edit">Sửa</a></li>
							<li><a class="dropdown-item" href="javascript:void(0)"  onClick="$Core.member.deleteField(this)" data-profile_id='{$profile_id}' data-field_id="{$key}" data-field="{$field}">Xoá</a></li>
						</ul>
					</div>
				</td>
			</tr>
