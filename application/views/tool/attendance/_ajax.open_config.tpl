		...
		<div class="modal-footer">					
			<div class="p__right d-flex gap-2 justify-content-end">
				...
				<select uid="{$uid}" class="slb_configs_{$uid} form-control iso-select2 js__do_config-change required" 
					onchange="$Core.attendance.do_change(this, event)" name="config_id" data-width="200px">
				...
				<button type="button" class="btn btn-primary" gId="{$gId}" onClick="$Core.attendance.do_config(this, event)">
