<div class="modal-dialog modal-xl">
	<form action="#" method="POST" onsubmit="return false;" class="modal-content">
		...
		<div class="modal-body">
			<div class="row">
				<div class="col-12 col-lg-7 border-end mb-2 mb-lg-0">
					...
					<div class="holder_share_customers max-height-500 webkit-scrollbar overflow-y-auto" 
						onscroll="$Core.crm.scroll_share_customers(this, event)" holderG="_customer">
				...
				<div class="col-12 col-lg-5">
					<div class="d-flex flex-wrap align-items-center justify-content-between bg-lighter p-2 rounded-2 mb-2">
						<div class="d-flex align-items-center gap-2 mb-2 mb-lg-0">
							<div class="w-px-125 select2-sm">
								<select onChange="$Core.crm.do_share_search(this, event)" data-field="department_id" 
									class="form-control iso-select2 search_field" holderG="_staff" data-width="100%">
									{$clsISO->getSelectByPropertyTypeNotTitle('_DEPARTMENT',$smarty.const._DEPARTMENT_SALE_ID)}
								</select>
							</div>
							<div class="form-group">
								<input type="text" onChange="$Core.crm.do_share_search(this, event)" onkeyup="$Core.crm.enter_share_search(this, event)" holderG="_staff" class="form-control form-control-sm search_field" data-field="keysearch" placeholder="Nhập từ khóa & nhấn Enter" />
							</div>
						</div>
						<div class="d-flex align-items-center gap-1 xs:w-100">
							...
							<button type="button" onClick="$Core.crm.remove_selected_staff(this, event)" uid="{$uid}" 
					...
					<div class="d-inline-flex gap-1 align-items-center mb-2">
						<a href="javascript:void(0);" class="text-muted" holderG="_staff" data-bs-toggle="tooltip" 
							title="Chọn tất cả" onClick="$Core.crm.check_all(this, event)">Chọn tất cả</a>
						<span>/</span>
						<a href="javascript:void(0);" class="text-muted" data-bs-toggle="tooltip" title="Bỏ chọn tất cả" 
							onClick="$Core.crm.uncheck_all(this, event)" holderG="_staff">Bỏ chọn tất cả</a>
					</div>
					<div class="holder_staff_customers max-height-500 webkit-scrollbar overflow-y-auto">
						<div class="max-height-500 overflow-y-auto webkit-scrollbar">
							{section name=i loop=$list_preloaders max=10}
							<div class="d-flex rounded-2 p-2 mb-1">
								<label class="d-flex align-items-center gap-2 ant-checkbox">
									<div class="animate-bg avatar-xs avatar rounded-pill"></div>
