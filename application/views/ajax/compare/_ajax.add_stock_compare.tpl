		...
		<div class="modal-body">
			...
			<div class="form-group mb-2">
				...
				<select name="block_id" id="" class="form-control form-select" onChange="$Core.global.compare.load_block_building(this,event)" _type="building">
					...
					{foreach from=$lstBlock item=_oItem key=key name=i}
			...
			<div class="form-group position-relative">
				<label for="name" class="form-label mb-1">Mã căn <span class="text-danger">*</span></label>
				<input class="form-control required ms_ " type="text" name="ms_code" value="" onfocus="$Core.global.compare.do_search_stock(this, event)" onkeyup="$Core.global.compare.do_search_stock(this, event)" uid="sugget_{$uid}" autocomplete="off" >
