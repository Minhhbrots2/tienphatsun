		...
		{if !empty($agency_hidden_stock_MOC)}
			...
			<th class="text-left">
				<div class="d-flex align-items-center gap-1">
					...
					<button class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Bật tất cả" key="{$key}" onClick="$Core.property.toggle_sw(this,event)" action="show"><i class="fa fa-eye" aria-hidden="true"></i></button>
				</div>
			</th>
			{/foreach}
		{/if}
