...
<link rel="stylesheet" href="{$URL_CSS}/leaflet/Control.FullScreen.css?v={$upd_version}" />
<script src="{$URL_JS}/leaflet/store.min.js?v={$upd_version}"></script>
<script src="{$URL_JS}/leaflet/Control.FullScreen.js?v={$upd_version}"></script>
		...
		<ol class="breadcrumb mb-2">
			...
			<li class="breadcrumb-item">
				<a href="{$clsProject->getLinkDetail($project_id,0,0,$oneProject)}">
					{$clsProject->getCode($project_id, $oneProject)}</a>
			</li>
	...
	<div class="card">
		<div class="card-body">
			<div class="d-flex justify-content-center mb-3">
				<div class="btn-group">
					{if !empty($is_project_block)}
					<a href="{$clsProperty->getLink('stock', [
					...
					{else}
					<a href="{$PCMS_URL}/project/p{$project_id}.html" class="btn flex-fill btn-outline-default">
