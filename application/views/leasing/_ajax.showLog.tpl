	...
	<div class="modal-content">
		<div class="modal-header position-relative d-block">
			<div class="d-flex justify-content-between">
				...
				<a type="button" class="btn btn-close" onClick="$Core.leasing.close_pop(this, event)" data-bs-dismiss="modal"></a>
			</div>
		</div>
				...
				<table class="table table-iloocal table-computer table-bordered">
					...
					<tbody>	
						{foreach from=$logs name=i item=log key=k}
							<tr class="awe__leasing-item awe__leasing-item-58 text-nowrap">
