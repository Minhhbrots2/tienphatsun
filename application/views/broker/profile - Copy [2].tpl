						...
						<div class="col-12">
							<div class="card mb-4">
								<div class="user-profile-header-banner relative">
									<img src="{$more_information.banner}" alt="Banner image" class="rounded-top w-100" id="image_banner" onerror="this.src='{$URL_IMAGES}/profile-banner-default.png'" height="400">
								...
								<div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-2">
									...
									<div class="box_avatar flex-shrink-0 mt-n2 mx-sm-0 ms-sm-4 mx-auto">
										<img src="{$FH_URL}/{$oneProfile.avatar}" alt="user image" class="d-block h-auto ms-0 rounded-circle user-profile-img" onerror="this.src='{$URL_IMAGES}/avatars/avatar.jpg'" id="image_avatar" width="150" height="150">
									...
									<div class="flex-grow-1 mt-3 mt-sm-5">
										<div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
											<div class="user-profile-info">
												<h4 class="fs-4 mb-2 fw-bold name_user">{$oneProfile.full_name}</h4>
						...
						<div class="tab-pane fade show active" id="pills-Profile" role="tabpanel" aria-labelledby="pills-Profile-tab">
							<div class="row">
										...
										<div class="card-body">
											...
											<ul class="list-unstyled mb-4 mt-3">
												<li class="d-flex flex-wrap align-items-start mb-2">
													<i class="bx bx-user fs-5"></i><span class="fw-semibold mx-2">Họ và tên:</span> 
												...
												<li class="d-flex flex-wrap align-items-start mb-2">
													<i class="bx bx-briefcase fs-5"></i><span class="fw-semibold mx-2">Kinh nghiệm:</span> 
													<span class="InputCRMHandler fs-6 text-break">
										...
										<div class="card-header d-flex justify-content-between align-items-center">
											...
											<div class="box_upload_image">
												<form action="" method="post" enctype="multipart/form-data">
													...
													<button type="button" class="btn btn-outline-primary text-nowrap" onclick="$Core.broker.uploadImage(this,event);" toId="images" toImg="list_image" data-type="images" profile_id="{$oneProfile.profile_id}">
								...
								<div class="col-xl-8 col-lg-8 col-md-7">
									...
									<div class="card card-action mb-4">
										<div class="card-body">
											<h5 class="card-title">Thành tích<a class="editInlineField ml-1" onClick="$Core.broker.editInlineField(this,{ldelim}p_field:'achievements',p_element:'textarea', 'p_id':{$oneProfile.profile_id}{rdelim})" p_element="textarea" p_field="achievements" p_id="{$oneProfile.profile_id}">{$clsISO->makeIcon('bx-pencil')}</a> </h5>  
											<div class="tinymce_content content_about">
										...
										<div class="card-body">
											...
											<div class="table-profile pt-3">
												<table class="table table-iloocal table-{$deviceType} table-bordered">
													...
													<tbody class="lst_certificate" id="lst_{$k}">
														{if !empty($more_information.$k)}
															{foreach from=$more_information.$k key=key item=item}
																<tr>
																	<td><img class="rounded" src="{$item.image}" alt="{$item.title}" width="50" height="50"></td>
																	<td>{$item.title}</td>
																	{if $k eq 'project'}
																		<td class="text-center">{$item.total_sale_project}</td>
																	{/if}
																	<td>
																		<div class="btn-group ml-2">
																			...
																			<ul class="dropdown-menu dropdown-menu-end" style="">
																				<li><a class="dropdown-item" href="javascript:void(0)"  onClick="$Core.broker.formAddField(this,'open')" data-field_id="{$key}"  data-field="{$k}" data-type="edit">Sửa</a></li>
																				<li><a class="dropdown-item" href="javascript:void(0)"  onClick="$Core.broker.deleteField(this,'delete')" data-field_id="{$key}" data-field="{$k}">Xoá</a></li>
																			</ul>
																		</div>
																	</td>
																</tr>
