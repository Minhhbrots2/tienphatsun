	...
	<div class="row">
		<div class="col-xxl-10 mx-auto">
			<section class="section_banner">
				<img class="w-100 radius-4" src="https://datvietgroups.vn/wp-content/uploads/2023/08/364681720_761627735973278_1561672330452090835_n-2048x779.jpg" alt="" height="400"> 
			</section>
			<div class="box_content card px-3">
				<div class="row">
					<div class="col-xxl-6">
						<div class="box_image">
							<img class="rounded-circle" src="https://user.futurehomes.vn//images/avatar/2024-04-20-09-23-53-vinhomes-ocean-park-1.jpg" height="150" width="150" alt="User avatar" onerror="this.src='{$URL_IMAGES}/avatars/avatar.jpg'" style="object-fit: cover">
							<span class="level">PRO</span> 
						</div>
						<div class="box-border-left bo">
							<span>Thông tin sale</span>
							<h1 class="text-upper">Trần Văn Trường</h4>
						</div>
					</div>
					<div class="col-xxl-6">
