            ...
            return t && t.requirejs || (t ? i = t : t = {}, function(e) {
                ...
                function v(t, n) {
                    return function() {
                        ...
                        return "string" != typeof i[0] && 1 === i.length && i.push(null), r.apply(e, i.concat([t, n]))
                    }
                }
                ...
                s = function(e, t) {
                    var n, i, o = w(e),
                        r = o[0];
                    return e = o[1], r && (n = _(r = m(r, t))), r ? e = n && n.normalize ? n.normalize(e, (i = t, function(e) {
                        return m(e, i)
                    })) : m(e, t) : (r = (o = w(e = m(e, t)))[0], e = o[1], r && (n = _(r))), {
                        f: r ? r + "!" + e : e,
                        n: e,
                        pr: r,
                        p: n
                    ...
                    var r, u, p, h, f, m, w = [],
                        $ = typeof i;
                    if (o = o || t, "undefined" === $ || "function" === $) {
                        for (n = !n.length && i.length ? ["require", "exports", "module"] : n, f = 0; f < n.length; f += 1)
                            if ("require" === (u = (h = s(n[f], o)).f)) w[f] = a.require(t);
                            else if ("exports" === u) w[f] = a.exports(t), m = !0;
                        else if ("module" === u) r = w[f] = a.module(t);
                        else if (g(l, u) || g(c, u) || g(d, u)) w[f] = _(u);
                        else {
                            if (!h.p) throw new Error(t + " missing " + u);
                            h.p.load(h.n, v(o, !0), y(u), {}), w[f] = l[u]
                        }
                        p = i ? i.apply(l[t], w) : void 0, t && (r && r.exports !== e && r.exports !== l[t] ? l[t] = r.exports : p === e && m || (l[t] = p))
                    } else t && (l[t] = i)
                ...
                return t.prototype.bind = function(t, n, i) {
                    var o = this,
                        r = ["open", "opening", "close", "closing", "select", "selecting", "unselect", "unselecting","focus","blur"],
