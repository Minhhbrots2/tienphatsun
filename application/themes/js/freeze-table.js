...
(function ($, window) {
  ...
  FreezeTable.prototype.buildColumnTable = function() {
    ...
    if (this.scrollable) {
      // Scrollable check and prevention
      var columnTableWrapHeight = this.$tableWrapper.outerHeight(false) - this.scrollBarHeight;
      columnTableWrapHeight = (columnTableWrapHeight > 0) ? columnTableWrapHeight : this.$tableWrapper.outerHeight(false);
