...
window.pannellum = function(J, f, m) {
    function Ba(r, v) {
        ...
        function na(a) {
            K && ("fullscreenonly" != b.mouseZoom || Ga) && (a.preventDefault(), Ja(), S = Date.now(), a.wheelDeltaY ? (U(b.hfov - 0.05 * a.wheelDeltaY), x.hfov = 0 > a.wheelDelta ? 1 : -1) : a.wheelDelta ? (U(b.hfov - 0.05 * a.wheelDelta), x.hfov = 0 > a.wheelDelta ? 1 : -1) : a.detail && (U(b.hfov + 1.5 * a.detail), x.hfov = 0 < a.detail ? 1 : -1), F())
        }
        function R(a) {
            Ja();
            S = Date.now();
        ...
        function Ia(a) {
            ...
            if (a.video) {
                ...
                e.target = "_blank", M.appendChild(e), c.style.cursor = "pointer", d.style.cursor = "pointer", e.appendChild(c)) : (a.sceneId && (c.onclick = c.ontouchend = function() {
        ...
        ha.innerHTML =
            '<a href="https://pannellum.org/" target="_blank">Pannellum</a> 2.4.1';
        C.appendChild(ha);
        ...
        this.setYaw = function(a, c, d, e) {
            c = c == m ? 1E3 : Number(c);
            a = (a + 180) % 360 - 180;
            c ? (180 < b.yaw - a ? a += 360 : 180 < a - b.yaw && (a -= 360), L.yaw = {
                startTime: Date.now(),
                startPosition: b.yaw,
                endPosition: a,
                duration: c,
