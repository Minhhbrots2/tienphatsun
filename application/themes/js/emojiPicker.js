...
const generateElements = (emojiInput) => {
  ...
  emojiTrigger.style = `position:absolute; bottom:8px; right:70px; text-decoration:none;`
  ...
  emojiList.style = `padding: 0;
    margin: 0;
    list-style: none;`
  const emojis = [0x1F601, 0x1F602, 0x1F603, 0x1F60D, 0x1F60A, 0x1F614, 0x1F613, 
	0x1F633, 0x1F631, 0x1F621, 0x1F621, 0x1F648, 0x1F62D, 0x1F44D, 0x1F389];
  emojis.map((item) => {
      const emojiLi = document.createElement('li')
      emojiLi.style = `display: inline-block; margin: 5px;`
