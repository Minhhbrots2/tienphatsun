...
(function($)
{
	...
	$.Redactor.modules = ['alignment', 'autosave', 'block', 'buffer', 'build', 'button',
						  'caret', 'clean', 'code', 'core','colorPicker', 'dropdown', 'file', 'focus',
	...
	Redactor.fn = $.Redactor.prototype = {
		...
		button: function()
		{
			return {
				build: function(btnName, btnObject)
				{
					...
					// click
					if (btnObject.func || btnObject.command || btnObject.dropdown || btnObject.colorPicker)
					{
					...
					if (btnObject.colorPicker){//btnName === 'backcolor' || btnName === 'fontcolor'
						//console.log(btnName);
						// var dropdown = $('<div class="redactor_dropdown" style="display: none;">');
						$button.addClass('redactor-toolbar-link-dropdown').attr('aria-haspopup', true);
						 $dropdown = $('<div class="redactor-dropdown redactor-dropdown-' + this.uuid + ' redactor-dropdown-box-' + btnName + '" style="display: none;">');
                        $button.data('dropdown', $dropdown);
						this.colorPicker.build($dropdown, btnName,btnObject);
				...
				onClick: function(e, btnName, type, callback)
				{
					...
					else if (type == 'colorPicker') this.colorPicker.show(e, btnName);
		...
		oldIE: function() {
		 ...
		 colorPicker: function() {
            return {
                build: function(dropdown, key, btnObject) {
					var mode;
					if (key === 'backcolor') {
						...
						$(swatch).click(function() {
							...
							if (mode === 'forecolor') {
								_self.$editor.find('font').replaceWith(function() {
									return $('<span data-verified="redactor" style="color: ' + $(this).attr('color') + ';">' + $(this).html() + '</span>');
								});
							}
							if (_self.browser('msie') && mode === 'BackColor') {
								_self.$editor.find('font').replaceWith(function() {
									return $('<span data-verified="redactor" style="' + $(this).attr('style') + '">' + $(this).html() + '</span>');
								});
							}
						});
					}
					var elnone = $('<a href="javascript:void(null);" class="redactor_color_none"></a>').html(this.lang.get('none'));
					if (key === 'backcolor') {
					...
					//this.observe.addDropdown($item, key, btnObject);
					//btnObject.item = elnone;
					//console.log('colorpicker: '+btnObject.element);
					//this.opts.observe.dropdowns.push(btnObject);
					return dropdown;
				},
				show: function(e, key) {
        ...
        getSelection: function() {
            ...
            if (window.getSelection) {//this.
                return window.getSelection();//this.
        ...
        getCurrentNode: function() {
            if (typeof window.getSelection !== 'undefined') {////this.
        ...
        getSelectedNode: function() {
            if (this.oldIE()) {
                return this.getSelection().parentElement();
            } else if (typeof window.getSelection !== 'undefined') {//this.
                var s = window.getSelection();//this.
                if (s.rangeCount > 0) {
