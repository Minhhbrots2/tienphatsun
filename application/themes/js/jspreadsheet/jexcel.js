    ...
    met.engineering = (function() {
        ...
        exports.CONVERT = function(number, from_unit, to_unit) {
            ...
            var units = [
                ...
                ["Ă¥ngstrĂ¶m", "Ă…", ["ang"], "length", false, true, 1e-10],
                ...
                ["cubic Ă¥ngstrĂ¶m", "ang3", ["ang^3"], "volume", false, true, 1e-30],
                ...
                ["pferdestĂ¤rke", "PS", null, "power", false, true, 735.49875],
                ...
                ["square Ă¥ngstrĂ¶m", "ang2", ["ang^2"], "area", false, true, 1e-20],
    ...
    var jexcel = (function(el, options) {
        ...
        var defaults = {
            ...
            text:{
                ...
                insertANewColumnBefore: 'Chèn cột bên trái',
                insertANewColumnAfter: 'Chèn cột bên phải',
                deleteSelectedColumns: 'Xóa cột đã chọn',
                renameThisColumn: 'Đổi tên cột',
                orderAscending: 'Sắp xếp từ A đến Z',
                orderDescending: 'Sắp xếp từ Z đến A',
                insertANewRowBefore: 'Chèn 1 hàng lên trên',
                insertANewRowAfter: 'Chèn 1 hàng xuống dưới',
                deleteSelectedRows: 'Xóa hàng đã chọn',
                editComments: 'Sửa nhận xét',
                addComments: 'Thêm nhận xét',
                comments: 'Nhân xét',
                clearComments: 'Xóa nhận xét',
                copy: 'Sao chép...',
                paste: 'Dán...',
                saveAs: 'Lưu...',
                about: 'About',
                areYouSureToDeleteTheSelectedRows: 'Bạn có chắc chắn muốn xóa hàng đã chọn?',
                areYouSureToDeleteTheSelectedColumns: 'Bạn có chắc chắn muốn xóa cột đã chọn?',
