;(function(root, factory) {
        ...
        if (!(e[n] && e[n].version > i)) {
            e[n] = function(e, t, n) {
                ...
                _initMenu: function() {
                    ...
                    })), this.opts.initMenu.call(this, this.$menu, this.$orig), this.$menu.attr("id", this.$menu.attr("id") || this.__getUniqueId()), this.$pnls = e('<div class="' + s.panels + '"></div>').append(this.$menu.children(this.conf.panelNodetype)).prependTo(this.$menu);
                    var t = [s.menu];
                ...
                _initPanel: function(e) {
                    ...
                    e.removeAttr("id"), e.is("ul, ol") && (e.wrap("<div></div>"), e = e.parent()), e.addClass(s.panel + " " + s.hidden).attr("id", n);
                    var i = e.parent("li");
                ...
                _initNavbar: function(t) {
                    if (this.trigger("initNavbar:before", t), !t.children("." + s.navbar).length) {
                        ...
                        if (i && i.length) {
                            ...
                            o.append('<a class="' + s.btn + " " + s.prev + '" href="#' + c + '"></a>')
                ...
                _initListview: function(t) {
                    ...
                    if (o && o.parent().is("." + s.listview) && !o.children("." + s.next).length) {
                        var r = o.children("a, span").first(),
                            l = e('<a class="' + s.next + '" href="#' + t.attr("id") + '"></a>').insertBefore(r);
    ...
    function(e) {
        ...
        e[t].addons[n] = {
            ...
            var t = this;
            this.opts[n].blockUI && (o.$blck || (o.$blck = e('<div id="' + i.blocker + '" class="' + i.slideout + '"></div>')), o.$blck.appendTo(o.$body).off(a.touchstart + "-" + n + " " + a.touchmove + "-" + n).on(a.touchstart + "-" + n + " " + a.touchmove + "-" + n, function(e) {
            ...
            setup: function() {
                ...
                if (o = e[t].glbl, "boolean" == typeof r && (r = {
                        ...
                        t.find("." + i.divider).each(function() {
                            ...
                            n.length && (t.children("." + i.next).length || (t.wrapInner("<span></span>"), t.prepend('<a href="#" class="' + i.next + " " + i.fullsubopen + '"></a>')))
                        })
                    }), r.fixed) {
            ...
            setup: function() {
                ...
                if (o = e[t].glbl, "undefined" != typeof a) {
                    ...
                    a.length && (e.each(a, function(o) {
                        ...
                        var h = e('<div class="' + i.navbar + '"></div>'),
                            f = c.height;
    ...
    function(e) {
        ...
        e[t].addons[n][i] = function(n, i, s) {
            ...
            var l = e('<span class="' + o.breadcrumbs + '"></span>').appendTo(n);
    ...
    function(e) {
        ...
        e[t].addons[n][i] = function(n, i) {
            var s = e[t]._c,
                a = (e[t].glbl, e('<a class="' + s.close + " " + s.btn + '" href="#"></a>').appendTo(n));
    ...
    function(e) {
        ...
        e[t].addons[n][i] = function(i, s) {
            var a, o, r, l = e[t]._c,
                d = e('<a class="' + l.next + " " + l.btn + '" href="#"></a>').appendTo(i);
    ...
    function(e) {
        ...
        e[t].addons[n][i] = function(i, s) {
            var a = e[t]._c,
                o = e('<a class="' + a.prev + " " + a.btn + '" href="#"></a>').appendTo(i);
            this.bind("initNavbar:after", function(e) {
    ...
    function(e) {
        ...
        e[t].addons[n][i] = function(n, i) {
            var s = e[t]._c,
                a = e('<div class="' + s.search + '"></div>').appendTo(n);
    ...
    function(e) {
        ...
        e[t].addons[n][i] = function(i, s) {
            var a, o, r, l = e[t]._c,
                d = e('<a class="' + l.title + '"></a>').appendTo(i);
            this.bind("openPanel:start", function(e) {
