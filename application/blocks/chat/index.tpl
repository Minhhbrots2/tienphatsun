...
<div id="fhchat" ng-controller="ChatCtrl as c" ng-cloak
	...
	<script>window.CHAT_BOOT = { profile_id: (typeof profile_id !== 'undefined' ? profile_id : 0), ajax: (typeof path_ajax_script !== 'undefined' ? path_ajax_script : '') };</script>
	<!-- FAB -->
		...
		<div class="fhc-body" id="fhc-ng-body" ng-class="{'fhc-body-jn': c.tab==='checkin' && c.ck.state==='journey'}">
			...
			<div ng-if="c.tab==='checkin'">
				...
				<div ng-if="!c.ck.loading && c.ck.my">
					...
					<!-- Header info + tiến độ -->					
					{/literal}
						{if $clsISO->checkPermissionGroup('DIRECTOR') || $clsISO->checkPermissionGroup('BUSINESS_AREA') || $clsISO->checkPermissionGroup('SALE_DIRECTOR') || $clsISO->_DEV()}
							<div class="fhc-info ng-scope border" ng-if="c.ck.state==='idle'" style="background:var(--fhc-warn-soft)">
								<a class="fhc-top" href="{$clsISO->getLink('report-checkin')}">
									<div class="fhc-clock">
						...
						{/if}
						{if $clsISO->checkPermissionGroup('DIRECTOR') || $clsISO->checkPermissionGroup('BO') || $clsISO->checkPermissionGroup('BUSINESS_AREA') || $clsISO->checkPermissionGroup('SALE_DIRECTOR') || $clsISO->_DEV()}
						<script>window.CHAT_CAN_STATS = 1;</script>
						{literal}
					...
					<div class="fhc-jn" ng-if="c.ck.state==='journey'">
						...
						<div class="fhc-jn-datebar" ng-if="c.ck.journey">
							...
							{/literal}{if $clsISO->checkPermissionGroup('DIRECTOR') || $clsISO->checkPermissionGroup('BUSINESS_AREA') || $clsISO->checkPermissionGroup('SALE_DIRECTOR') || $clsISO->_DEV()}{literal}
							<a class="fhc-jn-report d-none" href="{/literal}{$clsISO->getLink('report-checkin')}{literal}"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><rect x="7" y="11" width="3" height="6"/><rect x="12" y="7" width="3" height="10"/><rect x="17" y="13" width="3" height="4"/></svg> Báo cáo ngày</a>
							{/literal}{/if}{literal}
						</div>
